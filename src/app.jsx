  ...
  I: {
    ...
    script: {
      ...
      abertura: {
        ...
        script: "Oi [Nome]! Que bom falar com você! Primeira coisa: adorei sua energia, já deu pra sentir que vai ser uma conversa incrível. De onde você tá falando agora? Me conta um pouco de como está o seu dia.",
                    ...
                    {viewMode[profileKey] === 'scripts' && (
                      <div>
                        ...
                        {['situacao', 'problema', 'implicacao', 'necessidade'].map((spinType) => (
                          <div key={spinType} className="script-section">
                            <div 
                              className="script-title"
